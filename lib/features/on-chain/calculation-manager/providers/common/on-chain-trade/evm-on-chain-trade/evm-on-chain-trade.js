        ...
        this.feeInfo = {
            rubicProxy: {
                fixedFee: {
                    ...
                    tokenSymbol: evmOnChainTradeStruct.proxyFeeInfo?.fixedFeeToken.symbol || 'Unknown'
                },
                platformFee: {
                    percent: evmOnChainTradeStruct.proxyFeeInfo?.platformFee.percent || 0,
                    tokenSymbol: evmOnChainTradeStruct.proxyFeeInfo?.platformFee.token.symbol || 'Unknown'
                }
            }
        };
